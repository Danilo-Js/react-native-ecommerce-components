...
const ShoppingCart = ({ items, onUpdateQuantity, onRemoveItem, onCheckout, title, subTitle, language = 'en', styles: customStyles = {}, }) => {
    ...
    const handleQuantityChange = (id, change) => {
        ...
        const updated = cartItems.map(item => item.id === id
            ? Object.assign(Object.assign({}, item), { quantity: Math.max(1, item.quantity + change) }) : item);
        setCartItems(updated);
        const updatedQty = ((_a = updated.find(i => i.id === id)) === null || _a === void 0 ? void 0 : _a.quantity) || 1;
    ...
    return (<View style={[styles.container, customStyles.container]}>
      ...
      {(subTitle || t.defaultSubTitle) && (<Text style={[styles.subTitle, customStyles.subTitle]}> 
