...
const PaymentGateway = ({ onPaymentSubmit, title, subTitle, language = 'en', styles: customStyles = {}, }) => {
    ...
    const handlePayment = () => {
        ...
        const paymentDetails = { cardNumber, cardHolder, expirationDate, cvv, billingAddress };
    ...
    return (<ScrollView contentContainerStyle={[styles.container, customStyles.container]}>
      ...
      <TextInput style={[styles.input, customStyles.input]} placeholder={t.placeholders.cardNumber} keyboardType="numeric" value={cardNumber} onChangeText={setCardNumber} maxLength={16}/>
      <TextInput style={[styles.input, customStyles.input]} placeholder={t.placeholders.cardHolder} value={cardHolder} onChangeText={setCardHolder}/>
      <TextInput style={[styles.input, customStyles.input]} placeholder={t.placeholders.expirationDate} value={expirationDate} onChangeText={setExpirationDate} maxLength={5}/>
      <TextInput style={[styles.input, customStyles.input]} placeholder={t.placeholders.cvv} keyboardType="numeric" secureTextEntry value={cvv} onChangeText={setCvv} maxLength={3}/>
      <TextInput style={[styles.input, customStyles.input]} placeholder={t.placeholders.billingAddress} value={billingAddress} onChangeText={setBillingAddress}/>
