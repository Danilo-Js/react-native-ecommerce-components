...
const ProductDetail = ({ product, onAddToCart, onBuyNow, title, subTitle, language = 'en', styles: customStyles = {}, }) => {
    ...
    return (<ScrollView style={[styles.container, customStyles.container]}>
      ...
      {product.rating !== undefined && (<Text style={[styles.rating, customStyles.rating]}>⭐ {product.rating}</Text>)}
      ...
      <View style={[styles.buttonContainer, customStyles.buttonContainer]}>
        <TouchableOpacity style={[styles.button, customStyles.button]} onPress={() => onAddToCart(product)}>
          <Text style={[styles.buttonText, customStyles.buttonText]}>
            {t.addToCart}
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.button, customStyles.button]} onPress={() => onBuyNow(product)}>
          <Text style={[styles.buttonText, customStyles.buttonText]}>
            {t.buyNow}
          </Text>
        </TouchableOpacity>
