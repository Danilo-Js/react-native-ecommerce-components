...
const CouponCodeInput = ({ onApplyCoupon, onRemoveCoupon, placeholder = 'Enter coupon code', title, subTitle, styles: customStyles = {}, }) => {
    ...
    return (<View style={[styles.container, customStyles.container]}>
      ...
      {/* Input Field */}
      <TextInput style={[styles.input, customStyles.input]} placeholder={placeholder} value={coupon} onChangeText={setCoupon} editable={!isCouponApplied}/>
