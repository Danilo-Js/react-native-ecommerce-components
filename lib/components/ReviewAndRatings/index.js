...
const ReviewAndRatings = ({ reviews, averageRating, totalReviews, onAddReview, title, subTitle, styles: customStyles = {}, }) => {
    ...
    return (<View style={[styles.container, customStyles.container]}>
      ...
      <View style={[styles.inputContainer, customStyles.inputContainer]}>
        <TextInput style={[styles.input, customStyles.input]} placeholder="Your Name" value={user} onChangeText={setUser}/>
        <TextInput style={[styles.input, customStyles.input]} placeholder="Your Comment" value={comment} onChangeText={setComment} multiline/>
        <TextInput style={[styles.input, customStyles.input]} placeholder="Your Rating (1-5)" value={rating ? rating.toString() : ''} onChangeText={(value) => setRating(Number(value) || null)} keyboardType="numeric"/>
